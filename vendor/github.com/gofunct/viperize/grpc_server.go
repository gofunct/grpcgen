...
func ViperizeGrpcServer(name string) {
	viper.SetConfigName("grpcserver.yaml")  // name of config file (without extension)
	...
	if err := viper.ReadInConfig(); err != nil {
		log.Info("failed to read config file, writing defaults--> grpcserver.yaml")
		if err := viper.WriteConfigAs("grpcserver.yaml"); err != nil {
